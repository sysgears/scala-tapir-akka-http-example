...
object ProductServiceImpl {
  ...
  val live: ZLayer[ProductRepository, Nothing, services.ProductServiceImpl.ProductService] = ZLayer {
    for {
...
class ProductServiceImpl(productDao: ProductRepository) extends ProductService with LazyLogging {
